...
let ReportesController = class ReportesController {
    ...
    async getVisitasDia(fecha, tecnico, res) {
...
__decorate([
    (0, common_1.Get)('visitas-dia'),
    __param(0, (0, common_1.Query)('fecha')),
    __param(1, (0, common_1.Query)('tecnico')),
    __param(2, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, Object]),
    __metadata("design:returntype", Promise)
], ReportesController.prototype, "getVisitasDia", null);
__decorate([
    (0, common_1.Get)('ruta-grupo/:id'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], ReportesController.prototype, "getRutaGrupo", null);
