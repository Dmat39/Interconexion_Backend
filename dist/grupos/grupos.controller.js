...
let GruposController = class GruposController {
    ...
    agregarVecinos(id, body) {
        return this.svc.agregarVecinos(id, body.vecino_ids);
    }
    updateVecinoEstado(id, vecinoId, body) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], GruposController.prototype, "findHoy", null);
__decorate([
    (0, common_1.Get)(':id'),
...
__decorate([
    (0, common_1.Post)(':id/vecinos'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], GruposController.prototype, "agregarVecinos", null);
__decorate([
    (0, common_1.Patch)(':id/vecinos/:vecinoId'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Param)('vecinoId')),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, Object]),
    __metadata("design:returntype", void 0)
], GruposController.prototype, "updateVecinoEstado", null);
__decorate([
